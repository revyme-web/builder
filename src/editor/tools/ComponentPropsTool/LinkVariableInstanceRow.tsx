      ...
      <div className="flex items-center justify-between w-full" ref={btnRef}>
        ...
        <div className="flex items-center gap-2 w-full min-w-0">
          <button
            ...
            className="w-full min-w-0 h-[var(--control-height)] flex items-center gap-2 pl-1 pr-2 rounded-[var(--radius-lg)] bg-[var(--control-bg)] border border-[var(--control-border)] hover:border-[var(--control-border-hover)] text-xs text-[var(--text-primary)] transition-colors cursor-pointer"
