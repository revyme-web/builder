      ...
      {CURSOR_NAMES.map((name) => {
        ...
        return (
          <button
            ...
            style={{ cursor: name }}
            className={`
              flex flex-col items-center justify-center gap-1 p-2 cut-corners cut-border border transition-colors
              ${isSelected
                ? 'bg-[var(--accent)] border-[var(--accent)] [--cut-border-color:var(--accent)] text-[var(--accent-fg)]'
                : 'bg-[var(--grid-line)] border-[var(--control-border)] [--cut-border-color:var(--control-border)] hover:border-[var(--control-border-hover)] hover:[--cut-border-color:var(--control-border-hover)] text-[var(--text-primary)]'
              }
            `}
          >
