...
function SortableLayerRow({ layer, onEdit, onRemove }: {
  ...
  return (
    ...
    <div
      ...
      className={`relative flex items-center gap-2 px-2 py-1.5 cut-corners border transition-colors cursor-grab active:cursor-grabbing touch-none
    ...
    <div className="flex flex-col gap-2">
      ...
      <div className="flex gap-1.5">
        <button
          ...
          className="flex-1 h-[var(--control-height-sm)] text-xs bg-[var(--grid-line)] border border-[var(--control-border)] cut-corners cut-border hover:[--cut-border-color:var(--control-border-hover)] text-[var(--text-secondary)] hover:text-[var(--text-primary)] hover:border-[var(--control-border-hover)] transition-colors cursor-pointer"
        >
          + Gradient
        </button>
        <button
