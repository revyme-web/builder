        ...
        <div className="grid grid-cols-6 gap-1">
          {CLIPPATH_PRESETS.map((preset) => (
            <button key={preset.name}
              ...
              title={preset.name}
              className="h-[var(--control-height)] w-full bg-[var(--choice-bg)] border border-[var(--control-border)] hover:border-[var(--control-border-hover)] cut-corners cut-border hover:[--cut-border-color:var(--control-border-hover)] transition-colors relative overflow-hidden cursor-pointer">
