...
function ZIndexAtom() {
  ...
  return (
    <div className="flex items-center gap-1.5 w-full">
      ...
      <button
        className="shrink-0 w-7 h-[var(--control-height-sm)] flex items-center justify-center cut-corners cut-border hover:[--cut-border-color:var(--control-border-hover)] border border-[var(--control-border)] [--cut-border-color:var(--control-border)] text-[var(--text-secondary)] hover:bg-[var(--bg-hover)] hover:border-[var(--control-border-hover)] cursor-pointer text-sm"
