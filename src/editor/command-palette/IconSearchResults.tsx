            ...
            {icons.map((icon) => {
              ...
              return (
                <button
                  ...
                  className="w-full aspect-square flex items-center justify-center bg-[var(--grid-line)] hover:bg-[var(--bg-hover)] cut-corners cut-border border border-[var(--control-border)] [--cut-border-color:var(--control-border)] transition-colors disabled:opacity-50"
