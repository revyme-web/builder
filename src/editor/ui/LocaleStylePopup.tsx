      ...
      <div className="flex flex-col gap-2.5 p-0.5" data-locale-style-popup>
        ...
        <ToolRow label="Variable">
          ...
          >
            ...
            <span role="button" onClick={(e) => { e.stopPropagation(); clearAll(); }} className="text-[var(--accent-fg)] opacity-70 hover:opacity-100 text-sm leading-none" title="Remove localization">×</span>
          </button>
        </ToolRow>
        <ToolRow label="">
        ...
        <div className="border-t border-[var(--border-light)] mt-0.5 pt-2.5 flex flex-col gap-2.5">
          ...
          {nextFree && (
            <button
              ...
              className="w-full h-[var(--control-height)] cut-corners cut-border hover:[--cut-border-color:var(--control-border-hover)] bg-[var(--grid-line)] border border-[var(--control-border)] [--cut-border-color:var(--control-border)] hover:border-[var(--control-border-hover)] text-xs text-[var(--text-primary)] cursor-pointer transition-colors"
            >
              Add Condition
            </button>
          )}
