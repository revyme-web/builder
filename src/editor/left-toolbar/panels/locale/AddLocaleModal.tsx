          ...
          {!selected ? (
            ...
            <>
              ...
              <div className="flex-1 p-5 flex flex-col gap-4 overflow-y-auto scrollbar-hide">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <input
                    ...
                    className="w-full h-[var(--control-height)] px-3 text-xs bg-[var(--grid-line)] border border-[var(--control-border)] [--cut-border-color:var(--control-border)] cut-corners cut-border focus:[--cut-border-color:var(--accent)] text-[var(--text-primary)] placeholder:text-[var(--text-disabled)] focus:border-[var(--accent)] focus:outline-none transition-colors"
                  />
                </div>
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <input
                    ...
                    className="w-full h-[var(--control-height)] px-3 text-xs font-mono bg-[var(--grid-line)] border border-[var(--control-border)] [--cut-border-color:var(--control-border)] cut-corners cut-border focus:[--cut-border-color:var(--accent)] text-[var(--text-primary)] placeholder:text-[var(--text-disabled)] focus:border-[var(--accent)] focus:outline-none transition-colors"
                  />
                ...
                {existingLocales.length > 0 && (
                  <div className="flex flex-col gap-1">
                    ...
                    <select
                      ...
                      className="w-full h-[var(--control-height)] px-2 text-xs bg-[var(--grid-line)] border border-[var(--control-border)] [--cut-border-color:var(--control-border)] cut-corners cut-border focus:[--cut-border-color:var(--accent)] text-[var(--text-primary)] focus:border-[var(--accent)] focus:outline-none transition-colors cursor-pointer"
                    >
              ...
              <div className="flex items-center justify-end gap-2 px-5 py-3 border-t border-[var(--border-light)]">
                <button
                  onClick={onClose}
                  className="h-[var(--control-height)] px-4 text-xs bg-[var(--grid-line)] border border-[var(--control-border)] [--cut-border-color:var(--control-border)] cut-corners cut-border hover:[--cut-border-color:var(--control-border-hover)] text-[var(--text-primary)]  hover:border-[var(--control-border-hover)] transition-colors cursor-pointer"
                >
                  Cancel
                </button>
                <button
