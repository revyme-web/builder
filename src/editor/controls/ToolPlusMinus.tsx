  ...
  return (
    <div className="flex w-full items-center border border-[var(--control-border)] rounded-md overflow-hidden">
      <button
        ...
        className="flex-1 flex items-center justify-center h-7 transition-colors bg-[var(--choice-bg)] text-[var(--text-secondary)] hover:text-[var(--text-primary)] hover:bg-[var(--control-bg-hover)]"
      >
