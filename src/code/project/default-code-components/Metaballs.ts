// Metaballs — Code component template (Paper-derived WebGL shader: blobby forms merging and splitting).
//
...
export const METABALLS_COMPONENT = `'use client';

/** @label "Metaballs" */
/** @comment "Gooey metaballs that merge and split as they drift, blending up to four colors. Animates in preview and on the live site." */
/** @defaultWidth 600 */
/** @defaultHeight 400 */
/** @controls {
  "colorBack": { "type": "color", "label": "Background", "default": "#000000" },
  "color1": { "type": "color", "label": "Color 1", "default": "#6e33cc" },
  "color2": { "type": "color", "label": "Color 2", "default": "#ff5500" },
  "color3": { "type": "color", "label": "Color 3", "default": "#ffc105" },
  "color4": { "type": "color", "label": "Color 4", "default": "#f585ff" },
  "colorCount": { "type": "number", "label": "Colors used", "min": 1, "max": 4, "step": 1, "default": 4 },
  "count": { "type": "number", "label": "Balls", "min": 1, "max": 15, "step": 1, "default": 10 },
  "size": { "type": "number", "label": "Size", "min": 0.1, "max": 1, "step": 0.01, "default": 0.83 },
...
var __PAPER = (() => {
  ...
  // entries/metaballs.js
  var metaballs_exports = {};
  __export(metaballs_exports, {
...
\`;
  ...
  // ../paper-shaders/packages/shaders/src/shaders/metaballs.ts
  var metaballsMeta = {
    maxColorCount: 8,
    maxBallsCount: 20
  };
...
void main() {
  ...
  return __toCommonJS(metaballs_exports);
})();
...
function Metaballs({
  colorBack = '#000000', color1 = '#6e33cc', color2 = '#ff5500', color3 = '#ffc105', color4 = '#f585ff', colorCount = 4, count = 10, size = 0.83, scale = 1, speed = 1,
  ...props
}) {
  ...
  useEffect(() => {
    ...
    mount.setUniforms(Object.assign({ u_fit: 1, u_rotation: 0, u_offsetX: 0, u_offsetY: 0, u_originX: 0.5, u_originY: 0.5, u_worldWidth: 0, u_worldHeight: 0 }, {
      ...
      u_count: Math.round(count), u_size: size
    }));
  ...
  }, [colorBack, color1, color2, color3, color4, colorCount, count, size, scale, speed, isStatic]);
...
export default withResponsiveProps(Metaballs);
`;
